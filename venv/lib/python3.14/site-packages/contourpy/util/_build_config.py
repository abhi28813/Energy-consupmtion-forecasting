...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/private/var/folders/s6/5hzmn6lx4dz5nxs7k_0slzph0000gn/T/build-env-fbk27rsq/bin/python",

        # Package versions
        contourpy_version="1.4.0",
        meson_version="1.12.0",
        mesonpy_version="0.21.1",
        pybind11_version="3.1.0",

        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/Users/runner/work/contourpy/contourpy/.mesonpy-zsptvb52/lib/contourpy/util",
        source_dir=r"/Users/runner/work/contourpy/contourpy/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=true --native-file=/Users/runner/work/contourpy/contourpy/.mesonpy-zsptvb52/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
