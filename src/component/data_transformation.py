...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            # Numerical sensor readings that are median-imputed and scaled
            numerical_cols = [
            ...
            # Load_Type has a natural low -> high ordering
            ordinal_cols = ['Load_Type']
            load_type_categories = ['Light_Load', 'Medium_Load', 'Maximum_Load']

            # Nominal (unordered) categorical columns
            onehot_cols = ['WeekStatus', 'Day_of_week', 'Month']
            ...
            ordinal_pipeline = Pipeline(
                ...
                ('ordinal_encoder',OrdinalEncoder(categories=[load_type_categories])),
                ('scaler',StandardScaler())
                ]
            )
    ...
    def initate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_column_name = 'Usage_kWh'
            drop_columns = [target_column_name,'Date','Time']
